...
scenario = 'all_valid_data/'#os.getenv('TRAIN_SCENARIO') + '/'
print(f'Env Var Scenario: {scenario}')
# scenario = 'all_valid_data/'#'lowres_landsat_experiment/'
...
pre_trained=None#f'outputs/{scenario}mobility_all/landsat_78_last.tar' #'outputs/all_valid_data/landsat_all/landsat_21.tar' #None#'outputs/landsat_1000/landsat_25_last.tar'# last model save
stage = 'landsat/' 
save_scenario = 'all_valid_data_fixedlandsat/'
...
if data_type == 'landsat':
    ...
    datasets1 = SatelliteImageryDataset(node_list_path=node_list_path, 
                                        ...
                                        load_embeddings=True, embedding_fn='resnet_fixed_rectangle.pt')
