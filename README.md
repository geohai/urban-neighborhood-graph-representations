...
- Train
  - The train directory contains PyTorch deep learning code including dataset classes, model classes, and training loops. I need to clean it up a bit and make a config file. I implemented these models from scratch.
- Evaluate
